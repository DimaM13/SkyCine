    ...
    <div className="relative w-full h-80 md:h-[480px] rounded-3xl overflow-hidden shadow-2xl border border-white/10 group mb-8">
      ...
      <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end max-w-2xl z-10">
        ...
        <div className="flex flex-wrap items-center gap-2.5 mb-3">
          ...
          {media.resolution && (
            <span className="text-xs font-bold uppercase tracking-wider text-slate-200 bg-white/10 backdrop-blur-md px-2.5 py-1 rounded-full border border-white/10">
              {media.resolution}
            </span>
          )}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-white/10 hover:bg-white/20 text-white font-semibold text-sm flex items-center gap-2 border border-white/15 backdrop-blur-md hover:scale-105 active:scale-95 transition-all"
          >
