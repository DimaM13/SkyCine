...
import { Loader2, CheckCircle2, Play, Zap, Clock } from 'lucide-react';
...
export const BufferBarrierBanner: React.FC<BufferBarrierBannerProps> = ({
  ...
  return (
    <div className="absolute top-16 md:top-20 left-1/2 -translate-x-1/2 z-40 max-w-lg w-[92%] sm:w-auto animate-fade-in pointer-events-auto">
      <div className="bg-cinema-900/90 backdrop-blur-xl border border-amber-500/40 rounded-2xl p-3 sm:px-4 sm:py-3 shadow-[0_8px_32px_rgba(0,0,0,0.8),0_0_15px_rgba(245,158,11,0.2)] flex flex-col gap-2.5">
